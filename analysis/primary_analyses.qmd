...
```{r}
set.seed(42)
catOne(fit1A6P, reps = 500, estimator = "WLSMV", plot = FALSE, manual = FALSE)$cutoffs
catOne(fit1A2P, reps = 500, estimator = "WLSMV", plot = FALSE, manual = FALSE)$cutoffs
catOne(fit1G6P, reps = 500, estimator = "WLSMV", plot = FALSE, manual = FALSE)$cutoffs
catOne(fit1G2P, reps = 500, estimator = "WLSMV", plot = FALSE, manual = FALSE)$cutoffs
catOne(fit1Ge6P, reps = 500, estimator = "WLSMV", plot = FALSE, manual = FALSE)$cutoffs
catOne(fit1Ge2P, reps = 500, estimator = "WLSMV", plot = FALSE, manual = FALSE)$cutoffs
```
