...
physical_with_ci_mod <- c(
  sprintf("%s\n[%s;%s]", table5 |> filter(Measure == "Physical item") |> pull(height_2), 
    load_df_mod |> filter(measure == "height" & categories == 2 & item_name == "Koerpergroesse_realW") |> pull(ci.lower) |> papaja::printnum(gt1 = FALSE, digits = 3),
    load_df_mod |> filter(measure == "height" & categories == 2 & item_name == "Koerpergroesse_realW") |> pull(ci.upper) |> papaja::printnum(gt1 = FALSE, digits = 3)),
  sprintf("%s\n[%s;%s]", table5 |> filter(Measure == "Physical item") |> pull(height_6), 
    load_df_mod |> filter(measure == "height" & categories == 6 & item_name == "Koerpergroesse_realW") |> pull(ci.lower) |> papaja::printnum(gt1 = FALSE, digits = 3),
    load_df_mod |> filter(measure == "height" & categories == 6 & item_name == "Koerpergroesse_realW") |> pull(ci.upper) |> papaja::printnum(gt1 = FALSE, digits = 3)),
  sprintf("%s\n[%s;%s]", table5 |> filter(Measure == "Physical item") |> pull(weight_2), 
    load_df_mod |> filter(measure == "weight" & categories == 2 & item_name == "Koerpergewicht_realW") |> pull(ci.lower) |> papaja::printnum(gt1 = FALSE, digits = 3),
    load_df_mod |> filter(measure == "weight" & categories == 2 & item_name == "Koerpergewicht_realW") |> pull(ci.upper) |> papaja::printnum(gt1 = FALSE, digits = 3)),
  sprintf("%s\n[%s;%s]", table5 |> filter(Measure == "Physical item") |> pull(weight_6), 
    load_df_mod |> filter(measure == "weight" & categories == 6 & item_name == "Koerpergewicht_realW") |> pull(ci.lower) |> papaja::printnum(gt1 = FALSE, digits = 3),
    load_df_mod |> filter(measure == "weight" & categories == 6 & item_name == "Koerpergewicht_realW") |> pull(ci.upper) |> papaja::printnum(gt1 = FALSE, digits = 3)),
    sprintf("%s\n[%s;%s]", table5 |> filter(Measure == "Physical item") |> pull(age_2), 
    load_df_mod |> filter(measure == "age" & categories == 2 & item_name == "Alter_realW") |> pull(ci.lower) |> papaja::printnum(gt1 = FALSE, digits = 3),
    load_df_mod |> filter(measure == "age" & categories == 2 & item_name == "Alter_realW") |> pull(ci.upper) |> papaja::printnum(gt1 = FALSE, digits = 3)),
  sprintf("%s\n[%s;%s]", table5 |> filter(Measure == "Physical item") |> pull(age_6), 
    load_df_mod |> filter(measure == "age" & categories == 6 & item_name == "Alter_realW") |> pull(ci.lower) |> papaja::printnum(gt1 = FALSE, digits = 3),
    load_df_mod |> filter(measure == "age" & categories == 6 & item_name == "Alter_realW") |> pull(ci.upper) |> papaja::printnum(gt1 = FALSE, digits = 3))
)
...
table5 <- table5 |> 
  ...
  value = flextable::as_paragraph(physical_with_ci_mod)
  ) |>
